...
Object.defineProperty(exports, "__esModule", { value: true });
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const utilService_1 = __webpack_require__(/*! ./services/utilService */ "./src/app/services/utilService.ts");
...
let MinePage = class MinePage {
    constructor(route, router, restService, storageService, utilService) {
        this.route = route;
        this.router = router;
        this.restService = restService;
        this.storageService = storageService;
    ...
    loginInfos() {
        const address = crypto_1.Identities.Address.fromPassphrase(this.storageService.LoginPassphrase);
...
let ReceivePage = class ReceivePage {
    constructor(restService, storageService, utilService, router, alertCtrl) {
        this.restService = restService;
        this.storageService = storageService;
        this.utilService = utilService;
        this.router = router;
...
let SignPage = class SignPage {
    constructor(restService, alertCtrl, ngZone, utilService) {
        this.restService = restService;
        this.alertCtrl = alertCtrl;
        this.ngZone = ngZone;
        this.utilService = utilService;
